...
* ****`revokeConfirmation(uint256 _txIndex)`**** Revokes a previously submitted confirmation. Allows `onlyOwner` to remove their approval and Cannot revoke if never approved.
